...
describe('javascript-1-assessment', function() {
  ...
  describe('Problem 5 - boomCampGoal', function() {
    it('boomCampGoal variable should exist', function() {
      expect(boomCampGoal).toBeDefined();
    });
    it('should be the correct data type', function() {
      expect(typeof boomCampGoal).toBe('object');
    });
  });
  ...
  describe('Problem 9 - ', function() {
    ...
    it('should properly assign the dog name', function() {
      expect(boomCampClassPet).toBe(dog.name);
    });
  });
